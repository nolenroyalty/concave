                ...
                args: {},
                 handler: async (_ctx) => {
                  return "hello";
                       ...
                       export const functionHandleQuery = query({
                         args: {},
                          handler: async (ctx) => {
                           // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                            // @ts-ignore
                                    ...
                                    return {
                                     appHandle,
                                      componentHandle,
                                            ...
                                            export const functionHandleAction = action({
                                             args: {},
                                              handler: async (ctx) => {
                                                    ...
                                                    return {
                                                     appHandle,
                                                      componentHandle,
                                                           ...
                                                           export const queryCallsHandles = query({
                                                            args: {},
                                                             handler: async (ctx) => {
                                                              // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                                                               // @ts-ignore
                                                                   ...
                                                                   // @ts-ignore
                                                                    const result = await ctx.runQuery(queryHandle, { a: 1, b: 2 });
                                                                     ...
                                                                     throw new Error("Query handle did not return the correct value");
                                                                        ...
                                                                        export const mutationCallsHandles = mutation({
                                                                         args: {},
                                                                         handler: async (ctx) => {
                                                                          // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                                                                          // @ts-ignore
                                                                            ...
                                                                            // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                                                                             ...
                                                                             if (queryResult !== 3) {
                                                                              ...
                                                                              // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                                                                               ...
                                                                               // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                                                                               // @ts-ignore
                                                                               const mutationResult = await ctx.runMutation(mutationHandle, {
                                                                               a: 1,
                                                                               b: 2,
                                                                               });
                                                                               if (mutationResult !== 2) {
                                                                               ...
                                                                               export const actionCallsHandles = action({
                                                                              args: {},
                                                                              handler: async (ctx) => {
                                                           ...
                                                           export const passHandleToScheduler = mutation({
                                                          args: {},
                                                         handler: async (ctx) => {
                                                        // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                                                       // @ts-ignore
