 ...
 import { Id } from "./_generated/dataModel";
  import { mutation, query } from "./_generated/server";
    ...
    export const insert = mutation({
      handler: function ({ db }, { number }: { number: number }) {
       return db.insert("test", { hello: number });
        },
         });

            export const deleteDoc = mutation({
             handler: function ({ db }, { id }: { id: Id<"test"> }) {
              return db.delete(id);
               },
                 });
                   ...
                   export const get = query({
                    handler: function ({ db }, { id }: { id: Id<"test"> }) {
                     return db.get(id);
                          ...
                          export const filterScan = query({
                           handler: ({ db }, { number }: { number: number }) =>
                            db
                              .query("test")
                               .filter((q) => q.eq(q.field("hello"), number))
                                .collect(),
                                        ...
                                        .filter((q) => q.eq(q.field("hello"), number))
                                         .first(),
                                            ...
                                            export const parallelQuery = query({
                                             handler: async ({ db }, { numbers }: { numbers: number[] }) => {
                                                  ...
                                                  .filter((q) => q.eq(q.field("hello"), number))
                                                   .first(),
                                                        ...
                                                        export const parallelGet = query({
                                                         handler: async ({ db }, { ids }: { ids: Id<"test">[] }) => {
                                                                   ...
                                                                   db
                                                                    ...
                                                                    .filter((q) => q.eq(q.field("hello"), number))
                                                                     .first(),
                                                                        ...
                                                                        export const explicitScan = query({
                                                                         handler: ({ db }, { number }: { number: number }) => {
                                                                         return db
                                                                          .query("test")
                                                                          .fullTableScan()
                                                                           ...
                                                                           .collect();
                                                                             ...
                                                                             * These are kinda silly because `.filter(_q => true)` includes
                                                                              ...
                                                                              */
                                                                               ...
                                                                               export const trueLiteralFilter = query({
                                                                               args: {},
                                                                               handler: ({ db }) =>
                                                                               db
                                                                               .query("test")
                                                                               ...
                                                                               export const falseLiteralFilter = query({
                                                                                args: {},
                                                                               handler: ({ db }) =>
                                                                               db
                                                                               .query("test")
                                                                    ...
                                                                    handler: async (
                                                                   { db },
                                                                  { id, cursor }: { id: Id<"test">; cursor: string },
                                                                 ) => {
                                                                 return await db
                                                                .query("test")
                                                     ...
                                                     export const multiplePaginatedQueries = query({
                                                    args: {},
                                                    handler: async ({ db }) => {
                                              ...
                                              export const orderFilter = query({
                                             handler: async ({ db }, { min }: { min: any }) => {
                                            return await db
                                           .query("test")
                                          .order("desc")
                                   ...
                                   export const filterOrder = query({
                                  handler: async ({ db }, { min }: { min: any }) => {
                                 return await db
                                .query("test")
                               .filter((q) => q.gte(q.field("hello"), min))
            ...
            export const firstAfterPendingDeletes = mutation({
           args: {},
         handler: async ({ db }) => {
