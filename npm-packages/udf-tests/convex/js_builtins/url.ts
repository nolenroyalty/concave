  ...
  * and assert that it behaves as expected.
   ...
   * The test cases were pulled from Deno and the goal is to either pass the test
    ...
    * https://github.com/denoland/deno/blob/10e4b2e14046b74469f7310c599579a6611513fe/cli/tests/unit/url_test.ts
     *
     * Known limitations:
      *  - setting username/password in a URL is unsupported (CX-3088)
                                                ...
                                                assert.strictEqual(url.href, "https://baz.qat:8000/qux/quux?foo=bar&baz=12");
                                                 ...
                                                 //   url.host = "qat.baz:8080";
                                                  ...
                                                  url.hostname = "foo.bar";
                                                   ...
                                                   // setting password / username unsupported
                                                    //   url.password = "qux";
                                                    //   assert.strictEqual(
                                                    //     url.href,
                                                                           ...
                                                                           function urlProtocolSlashes() {
                                                                            ...
                                                                            function urlRequireHost() {
                                                                             ...
                                                                             function urlDriveLetter() {
                                                                              ...
                                                                              assert.strictEqual(
                                                                             new URL("", "file://foo/a/b?c#d").href,
                                                                             "file://foo/a/b?c",
                                                                             );
                                                                             assert.strictEqual(
                                                                             new URL("", "abcd://foo/a/b?c#d").href,
                                                                             "abcd://foo/a/b?c",
                                                                             );
                                                                            ...
                                                                            assert.strictEqual(
                                                                            new URL("#e", "file://foo/a/b?c#d").href,
                                                                            "file://foo/a/b?c#e",
                                                                            );
                                                                            assert.strictEqual(
                                                                            new URL("#e", "abcd://foo/a/b?c#d").href,
                                                                           "abcd://foo/a/b?c#e",
                                                                           );
