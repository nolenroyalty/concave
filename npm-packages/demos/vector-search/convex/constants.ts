                                                              ...
                                                              Adventure: "🏔",
                                                               ...
                                                               "Science Fiction": "👩‍🔬",
                                                                 ...
                                                                 export const EXAMPLE_MOVIES = [
                                                                  ...
                                                                  title: "Inception",
                                                                  description:
                                                                   "A skilled thief enters people's dreams to steal their secrets, but his latest job involves planting an idea into someone's mind.",
                                                                   genre: "Action",
                                                                   },
                                                                   {
                                                                  ...
                                                                  description:
                                                                 "A young hobbit named Frodo must journey to destroy a powerful ring before it falls into the hands of dark forces.",
                                                                 genre: "Adventure",
                                                                },
                                                               {
                                                               title: "Pulp Fiction",
                                                              description:
                                                             "The lives of multiple characters intertwine in a series of interconnected crime stories.",
                                                            genre: "Drama",
                                                            },
                                                           {
                                                          title: "Jurassic Park",
                                                         description:
                                                       "A wealthy entrepreneur invites scientists to a remote island to showcase a new amusement park filled with cloned dinosaurs, but things quickly go awry.",
                                                      genre: "Adventure",
                                                     },
                                                    {
                                                   title: "The Matrix",
                                                 description:
                                                "A computer hacker discovers that reality as he knows it is a simulation created by machines, and he joins a group of rebels to fight against them.",
                                               genre: "Science Fiction",
                                             },
                                            {
                                          title: "Forrest Gump",
                                        description:
                                       "A man with a low IQ recounts his extraordinary life experiences, inadvertently influencing numerous historical events along the way.",
                                     genre: "Drama",
                                    },
                                  {
                                title: "Star Wars: Episode IV - A New Hope",
                              description:
                             "A young farm boy joins a rebellion against an evil empire and becomes entangled in a battle to save the galaxy.",
                           genre: "Science Fiction",
                         },
                       {
                     title: "Avatar",
                   description:
                 "A paraplegic marine is sent to the moon Pandora, where he becomes torn between following orders and protecting the indigenous people and their way of life.",
               genre: "Science Fiction",
             },
           {
         title: "The Dark Knight",
       description:
     "Batman faces off against the Joker, a psychopathic criminal mastermind, in a battle to save Gotham City from chaos.",
   genre: "Action",
 },
];
