                    ...
                    Choose how you want your users to sign in.
                     ...
                     <p style={{textAlign: 'center'}}>
                      <img src="/screenshots/clerk-createapp.png" alt="Create a Clerk application" width={200} />
                       ...
                       <Step title="Activate the Convex integration in Clerk">
                        In the Clerk Dashboard, activate the [Convex integration](https://dashboard.clerk.com/apps/setup/convex).

                        <p style={{textAlign: 'center'}}>
                         <img src="/screenshots/clerk-convex-integration.png" alt="Activate the Convex integration in Clerk" width={400} />
                         </p>
