     ...
     Poll,
         ...
         use futures::io as futures_io;
          use pin_project::pin_project;
           /// Re-export so crates can type-annotate when using Compat.
            pub use tokio::io::AsyncRead as TokioAsyncRead;
                                                             ...
                                                             where
                                                              Self: Sized,
                                                               ...
                                                               Compat::new(self)
                                                                 ...
                                                                 fn compat_mut_write(&mut self) -> Compat<&mut Self>
                                                                 where
                                                                  Self: Sized,
                                                                  {
                                                                   Compat::new(self)
                                                                     ...
                                                                     impl<T: tokio::io::AsyncWrite> TokioAsyncWriteCompatExt for T {}
                                                                      ...
                                                                      fn new(inner: T) -> Self {
                                                                       ...
                                                                       seek_pos: None,
                                                                         ...
                                                                         /// Get a reference to the `Future`, `Stream`, `AsyncRead`, or `AsyncWrite`
                                                                         /// object contained within.
                                                                          pub fn get_ref(&self) -> &T {
                                                                          &self.inner
                                                                          }

                                                                           /// Get a mutable reference to the `Future`, `Stream`, `AsyncRead`, or
                                                                           /// `AsyncWrite` object contained within.
